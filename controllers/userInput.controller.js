...
exports.update = async (req, res) => {
    try {
        ...
        // Atualize os campos do documento com os valores do corpo da requisição
        Object.keys(req.body).forEach(key => {
            if (key === 'answers' && Array.isArray(req.body.answers)) {
                // Adicione as novas respostas ao array existente de "answers"
                userInput.answers.push(...req.body.answers);
            } else {
